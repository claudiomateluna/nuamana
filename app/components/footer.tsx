...
import { IconoRRSSInstagram, IconoRRSSFacebook, IconoRRSSYoutube, IconoRRSSTiktok, IconoRRSSGoogle, IconoRRSSEmail, IconoRRSSWhatsApp } from './ui/iconos';
import UnitSlideShow from './unit-slideshow';

const NuaManaFooter = () => {
  return (
    <footer className="bg-gradient-to-br from-(--clr1)/30 from-5% via-(--dclr6)/30 via-35% to-(--clr6)/60 dark:from-(--dclr7) dark:from-5% dark:via-(--clr5) dark:via-55% dark:to-(--clr4) text-(--clr5) dark:text-(--dclr2) py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-6">
          ...
          <div className="sm:col-span-2 lg:col-span-1 text-center sm:text-left hidden sm:block">
            ...
            <div className="text-center sm:text-left">
              <h4 className="text-lg font-bold leading-1 uppercase text-center text-(--dclr5) dark:text-gray-300">Guías y Scouts Nua Mana</h4>
              <h5 className="text-md italic text-center text-(--dclr5) dark:text-gray-300">una nueva aventura</h5>
            </div>
            <p className="mt-4 text-md text-gray-600/80 dark:text-gray-400 text-justify leading-relaxed">
            ...
            <div className="flex justify-between mt-6 max-w-xs mx-auto">
              <a href="https://www.instagram.com/gruponuamana/" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSInstagram className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="https://facebook.com/gruponuamana" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSFacebook className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="https://youtube.com/@gruponuamana" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSYoutube className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="https://www.tiktok.com/@gruponuamana" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSTiktok className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="https://www.google.com/search?q=Guías+y+Scouts+Nua+Mana" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSGoogle className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="mailto:contacto@nuamana.cl" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
                <IconoRRSSEmail className="h-8 w-8" strokeWidth={0.2} />
              </a>
              <a href="https://wa.me/56966896001" target="_blank" rel="noopener noreferrer" className="hover:text-(--clr7) dark:hover:text-(--clr8) transition-colors">
          ...
          <div className="sm:col-span-1 lg:col-span-1 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2">
              ...
              <div className="text-center sm:text-left">
                <a href="/acerca-de/institucion-patrocinante" target="_self" rel="noopener noreferrer" className="block text-(--clr3) dark:text-(--clr8) dark:hover:text-(--clr1) font-semibold mb-1 hover:underline">
                  Colegio Los Navíos
                </a>
                <p>
        ...
        <div className="border-t border-[#34495e] pt-6 text-center">
          <p className="text-sm text-(--clr3) dark:text-gray-400">
